            ...
            <tbody>
                ...
                if (mysqli_num_rows($select_cart) > 0) {
                    while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                        $sub_total = $fetch_cart['price'] * $fetch_cart['qty']; // Calculate subtotal without formatting
                ...
                <tr>
                    ...
                    <td>TK <?php echo number_format($sub_total); ?>/-</td>
                ...
                <tr class="table-bottom">
                    ...
                    <td>TK <?php echo number_format($grand_total); ?>/-</td>
                    <td><a href="cart.php?delete_all" onclick="return confirm('Are you sure you want to delete all?');" class="delete-btn"> <i class="fas fa-trash"></i> delete all </a></td>
                </tr>
            </tbody>
        </table>
        <div class="checkout-btn">
            <a href="checkout.php" class="button-div <?= ($grand_total > 1) ? '' : 'disabled'; ?>">proceed to checkout</a>
        </div>
    </section>
</div>
