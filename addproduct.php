...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        ...
        $statement = $conn->prepare("INSERT INTO products(name, image, price, category, product_details) VALUES(?, ?, ?, ?, ?)");
        $statement->bind_param("ssdss", $pName, $imgData, $price, $category, $des);
